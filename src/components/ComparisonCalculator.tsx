...
const ComparisonCalculator = () => {
  ...
  const INDEPENDENT_ANNUAL_FEE = 1.0; // 1.0% annual fee for independent advisor
    ...
    <section className="py-20 bg-white">
      <div className="container-custom">
        <div className="text-center mb-16">
          <h2 className="section-title">Quanto Puoi Risparmiare?</h2>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Calcola quanto puoi risparmiare scegliendo un consulente finanziario indipendente come TORO Consulting rispetto a un consulente tradizionale.
          </p>
        </div>

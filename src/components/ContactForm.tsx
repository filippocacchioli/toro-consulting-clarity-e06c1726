      ...
      <div className="container-custom">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <div className="space-y-6">
              <div className="flex items-start">
                <div className="h-12 w-12 rounded-full bg-toro-gold/20 flex items-center justify-center mr-4">
                  <svg className="h-6 w-6 text-toro-gold" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                  </svg>
                </div>
                <div>
                  <h3 className="text-lg font-medium text-toro-dark mb-1">Telefono</h3>
              ...
              <div className="flex items-start">
                ...
                <div>
                  <h3 className="text-lg font-medium text-toro-dark mb-1">Email</h3>
              ...
              <div className="flex items-start">
                ...
                <div>
                  <h3 className="text-lg font-medium text-toro-dark mb-1">Indirizzo</h3>
            ...
            <div className="mt-8">
              <p className="text-lg font-medium text-toro-dark mb-4">Seguici sui social</p>
              <div className="flex space-x-4">
                <a href="https://www.linkedin.com/in/filippo-cacchioli-041ab43/" target="_blank" rel="noopener noreferrer" className="h-10 w-10 rounded-full bg-toro-dark flex items-center justify-center text-white hover:bg-toro-gold transition-colors">
                  <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"></path>
                  </svg>
                </a>
                <a href="#" className="h-10 w-10 rounded-full bg-toro-dark flex items-center justify-center text-white hover:bg-toro-gold transition-colors">
                  <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
